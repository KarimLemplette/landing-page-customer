            ...
            <MDBContainer breakpoint="md" className='container-fluid'>
                <MDBRow className='d-flex align-items-center'>
                        <MDBCol size='md' className='col-md-7 order-sm-first order-last'>
                            <h1 className="header-h2 responsive-header-h2"><span style={{color: '#ffc107'}}>Trouvez</span> le produit que vous recherchez dans un commerce à <span style={{color: '#ffc107'}}>{CityName}</span> </h1>
